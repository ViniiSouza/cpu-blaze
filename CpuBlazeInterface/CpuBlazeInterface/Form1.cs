namespace CpuBlazeInterface
{
    public partial class Form1 : Form
    {
        ...
        private void BtnCompile_Click(object sender, EventArgs e)
        {
            ...
            // Encontrar o diretório do arquivo .c
            ...
            // Compilar em thread separada para não travar a UI
            Task.Run(() =>
            {
                ...
                if (InvokeRequired)
                {
                    Invoke(new Action(() =>
                    {
                        if (success)
                        {
                            ...
                            // Tentar encontrar o executável novamente
        ...
        {
            // Procurar o arquivo cpu_blaze.c
            string appDir = Application.StartupPath;
            DirectoryInfo? currentDir = new DirectoryInfo(appDir);
